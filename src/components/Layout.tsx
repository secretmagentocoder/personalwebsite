...
import { Menu, X, Code, Mail, FileText } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-bold">ANAS KP</span>
              </div>
              <p className="text-gray-400">
                Web Developer & Ecommerce Team Lead specializing in Magento 2 development with 7+ years of experience.
              </p>
            </div>
            <div>
